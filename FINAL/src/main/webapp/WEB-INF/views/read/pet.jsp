   ...
   <div id="page">
      ...
      <div id="content">
         <table id="tbl1">
            <tr class = "box">
               <td>
                  <img id="pet1" page=1 src="../display?fileName=pet-1.jpg" width=500>
               </td>
               <td rowspan=2>
                  <img id="pet2" page=2 src="../display?fileName=pet-2.jpg" width=600>
               </td>
            </tr>
            <tr class = "box">
               <td>
                  <img id="pet3" page=3 src="../display?fileName=pet-3.jpg" width=500>
               </td>
            </tr>
            <tr class = "box">
               <td>
                  <img id="pet4" page=4 src="../display?fileName=pet-4.jpg" width=500>
               </td>
               <td>
                  <img id="pet5" page=5 src="../display?fileName=pet-5.jpg" width=500>
               </td>
            </tr>
         </table>
      <div>
