   ...
   <div id="page">
      ...
      <div id="content">
         <table id="tbl1">
            <tr class = "box">
               <td colspan=2>
                  <img id="friend1"  page=1 src="../display?fileName=friend-1.jpg" width=1000>
               </td>
            </tr>
            <tr class = "box">
               <td>
                  <img id="friend2" page=2 src="../display?fileName=friend-2.jpg" width=500>
               </td>
               <td>
                  <img id="friend3" page=3 src="../display?fileName=friend-3.jpg" width=500>
               </td>
            </tr>
            <tr class = "box">
               <td colspan=2>
                  <img id="friend4" page=4 src="../display?fileName=friend-4.jpg" width=1000>
               </td>
            </tr>
         </table>
      <div>
...
<script>
var src1="../display?fileName=friend-";
var src2=".jpg";
var page;
