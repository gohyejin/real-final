...
<body>
   <div id="divSignUpPage">
      ...
      <form name="frm" action="/user/insert" method="post">
         <div class="btn">
            <input type="text" size=28 placeholder="　　ID" maxlength="20" id="users_id" name="users_id" value="${users_id}" required/>
            <input type="button" value="중복확인" id="idCheck">
         </div><br>
         <div class="btn">
            <table class="checks">
	            <tr>
	            	<td><input type="password" size=28 placeholder="　　PASSWORD" maxlength="20" id="users_pass" name="users_pass" value="${users_pass}" required/></td>
         ...
         <div class="btn"><input type="text" size=40 placeholder="　　NAME" name="users_name" value="${users_name}" required/></div><br>
         <div class="btn">
            <input type="text" size=10 placeholder=" YEAR" id="users_birthdayYear" name="users_birthdayYear" value="${users_birthdayYear}" maxlength=4 minlength=4 required/> -
            <input type="text" size=10 placeholder=" MONTH" id="users_birthdayMonth" name="users_birthdayMonth" value="${users_birthdayMonth}" maxlength=2 minlength=2 required/> -
            <input type="text" size=10 placeholder=" DAY" id="users_birthdayDay" name="users_birthdayDay" value="${users_birthdayDay}" maxlength=2 minlength=2 required/>
            <input type="hidden" name="users_birthday" id="users_birthday">
         </div><br>
         <div class="checks">
         	<input type="radio" name="gender" size=28 id="ex_chk" required value="남자" <c:out value="${users_gender=='남자'?'checked':''}"></c:out>></input> <label for="ex_chk">남자</label>
            <input type="radio" name="gender" size=28 id="ex_chk1" required value="여자" <c:out value="${users_gender=='여자'?'checked':''}"></c:out>></input> <label for="ex_chk1">여자</label>
            <input type="hidden" name="users_gender" id="users_gender">
         </div><br>
         <div class="btn">
            <input type="text" size=28 placeholder="　　ZIP CODE" id="users_zipCode" name="users_zipcode" value="${users_zipcode}" required/>
            <span><button onClick="openAddress();">우편번호</button></span>
         </div><br>
         <div class="btn">
            <input type="text" size=40 placeholder="　　ADDRESS" id="users_address" name="users_addresss" value="${users_addresss}" required/>
         </div><br>
         <div class="btn">
            <input type="text" size=40 placeholder="　　ADDRESS DETAIL" id="users_addressDetail" name="users_addressDetail" value="${users_addressDetail}"/>
...
<script>
   ...
   $("#btnShow").mouseover(function(){
      ...
      $(".btn #users_passChk").prop("type", "text");
   });
   $("#btnShow").mouseout(function(){
      $(".btn #users_pass").prop("type", "password");
      $(".btn #users_passChk").prop("type", "password");
   });
