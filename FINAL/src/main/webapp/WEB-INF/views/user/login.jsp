...
<body>
	<div id="divLoginPage">
		...
		<div id="id"><input type="text" size=40 id="users_id" placeholder="　　ID" maxlength="20"/></div><br>
		<div id="pw"><input type="password" size=40 id="users_pass" placeholder="　　PASSWORD" maxlength="20"/></div>
