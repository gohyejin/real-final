	...
	<div id="orderList">
		...
		<table id="tbl1">
			...
			<tr class="row">
				...
				<td>${vo.package_cart_price}</td>
				<td>${vo.package_cart_quantity}</td>
...
$("#pagination a").click(function(e){
	...
	location.href="pchart?page="+page;
});

if(frm.keyword=="카카오") {
	$(frm.keyword).val("0");
}else if(frm.keyword=="현금") {
	$(frm.keyword).val("1");
}
