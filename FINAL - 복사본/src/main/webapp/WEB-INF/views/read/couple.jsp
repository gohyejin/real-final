   ...
   <div id="page">
      ...
      <div id="content">
         <table id="tbl1">
            <tr class = "box">
               <td>
                  <img id="couple1" page="1" src="../display?fileName=couple-1.jpg" width=500>
               </td>
               <td>
                  <img id="couple2" page="2" src="../display?fileName=couple-2.jpg" width=500>
               </td>
            </tr>
            <tr class = "box">
               <td colspan=2>
                  <img id="couple3" page="3" src="../display?fileName=couple-3.jpg" width=1000>
               </td>
            </tr>
            <tr class = "box">
               <td>
                  <img id="couple4" page="4" src="../display?fileName=couple-4.jpg" width=500>
               </td>
               <td>
                  <img id="couple5" page="5" src="../display?fileName=couple-5.jpg" width=500>
               </td>
            </tr>
         </table>
      <div>
